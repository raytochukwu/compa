...
const HowItWorks = () => {
  return (
    <section className="py-12 px-6 w-full">
      ...
      <h1 className=" font-semibold text-5xl leading-[72px]">Find Best Rate</h1>

        </div>
      <div className="flex flex-col lg:flex-row justify-center mb-[48px] gap-6">
        <div className="text-center w-[410px] h-[400px] rounded-3xl py-6 px-6 border ">
        ...
        <div className="text-center bg-[#E6FEFE] w-[410px] h-[400px] rounded-3xl py-6 px-6 border">
